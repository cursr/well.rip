...
class _app {
  ...
  brandDescription = ['Have all your socials connected with one link.', 'Well.rip is a website that lets you to create your own multi link profile.', 'Coming', 'Very', 'Soon', 'discord.gg/rank'];
